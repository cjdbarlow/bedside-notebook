...
:::column-margin
This covers epidemiology and determination of brain death in a general Australian context. Management of the brain dead patient proceeding to organ donation is covered at @sec-braindeathmx.
:::
...
* **Coma**\
GCS 3; with no motor response following painful stimulus applied centrally and to all four limbs.
...
\
EEG is similarly unhelpful; absence of cortical activity does not confirm brainstem death and electrical activity in some cortical cells does not indicate brain functioning.
:::
