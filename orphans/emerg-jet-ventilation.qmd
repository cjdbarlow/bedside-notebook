...
Relative contraindication.
	...
	* May also lead to significant barotrauma\
	Lower flow rates (5-7L.min^-1^ should be used with persistent obstruction).
...
* Method for jet ventilation
	...
	* MacGuyver Technique\
	A 3-way stopcock can be connected to the cannula and oxygen tubing running at 15 L.min^-1^. Intermitently occluding the third port on the stop-cock facilitates ventilation.
...
* Pressure related:
	...
	* Cardiovascular instability\
	Impaired RV function due to ↓ preload/↑ afterload.
* Kinking of catheter
* Bleeding
* Infection
