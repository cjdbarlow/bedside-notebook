...
**Unreasonable**, **repeated** or pattern of **behaviour that creates** a **risk** to health and safety.
	...
	* Divided into:
		* **Direct bullying**\
		Overt conduct, including: aggression, intimidation, spreading misinformation, interfering with property, or displaying offensive material.
		* **Indirect bullying**\
		Excludes or removes a person, including: assigning meaningless tasks, altering rosters to inconvenience someone, withholding information required for work.
