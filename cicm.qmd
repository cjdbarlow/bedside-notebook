...
The hot case is the only part of the exam that to assesses a candidate at the bedside. The hot case is:

* Artificial
* Incompletely correlated with clinical skill
	* Hot case practice ↑ hot case performance
...
* Composed of several stages:
	...
	* **Reading time**\
	2 minutes. Decide:
		...
		* What part of the examinations should be focused on?
	...
	* **Clinical examination**\
		...
		* Can ask key, targeted, relevant questions\
		Must be balanced.
			* Too many unnecessary or boilerplate questions suggest a lack of direction or though
	...
	* **Presentation**\
	3-5 minute presentation that:
		* Should be concise, comprehensive, and *rapidly* delivered
		* Consists of:
