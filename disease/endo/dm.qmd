# Diabetes Mellitus {#sec-dm}

:::column-margin
This covers general considerations and perioperative management of diabetes. The diabetic crises are covered such as DKA, HHS, and euglycaemic DKA are covered at @sec-dka, @sec-hhs, and @sec-edka respectively.
:::
...
### Perioperative Management {#sec-periop_dm}
...
+=====================+=================================+====================================================+======================================+================================================+
| Short Acting        | - Novorapid                     | - Usual doses                                      | - Withhold                           | - Half usual dose with early morning breakfast |
|                     | - Humalog                       | - **Half** usual dose during bowel **preparation** | - Give sliding scale                 |                                                |
|                     | - Actrapid                      |                                                    |                                      |                                                |
+---------------------+---------------------------------+----------------------------------------------------+--------------------------------------+------------------------------------------------+
| Intermediate Acting | - Protaphane                    | - Give 2/3^rds^ of usual dose                      | - Withhold                           | - Half usual dose with early morning breakfast |
|                     | - Humulin NPH                   | - **Half** usual dose during bowel **preparation** | - Give sliding scale                 |                                                |
+---------------------+---------------------------------+----------------------------------------------------+--------------------------------------+------------------------------------------------+
| Long Acting/Basal   | - Lantus                        | - Give 2/3^rds^ of usual dose                      | -  Give 2/3^rds^ of usual dose       | - Give 2/3^rds^ of usual dose                  |
|                     | - Levemir                       | - **Half** usual dose during bowel **preparation** |                                      |                                                |
+---------------------+---------------------------------+----------------------------------------------------+--------------------------------------+------------------------------------------------+
| Pre-mixed           | - Novomix 30                    | - Give normal dose with dinner                     | - Withhold                           | - Half usual dose with early morning breakfast |
|                     | - Humalog Mix 25/Humalog Mix 50 | - **Half** usual dose during bowel **preparation** | - Give sliding scale                 | - Give sliding scale                           |
|                     | - Mixtard 30/70                 |                                                    |                                      |                                                |
+---------------------+---------------------------------+----------------------------------------------------+--------------------------------------+------------------------------------------------+
...
:::column-margin
HHS is covered in detail under @sec-hhs.
:::
...
* Results in complications for both:
	...
	* Foetus
		* Placental insufficiency\
			...
			* Reduced oxygen transport on HbA~1c~
		* Foetal macrosomia
			* Shoulder dystocia
