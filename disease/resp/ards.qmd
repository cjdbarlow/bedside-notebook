...
* **Non-hydrostatic**\
Not related to an increased PCWP, i.e. not due to LV failure.
* **Hypoxia**\
...
Epithelial cell damage alters cellular production of inflammatory mediators and increases water egress into the alveolus, as well as production of dysfunctional surfactant.
    ...
    * **Lung protective ventilation**\
        * Appropriate PEEP\
        Often titrated to a PEEP-FiO~2~ table. Considerations:
            ...
            * Excessive PEEP tends to cause over-distension, increased lung stress, and reduced cardiac output
...
Increased Mortality compared to lung protective ventilation strategies.
* Recruitment Manoeuvres\
In theory, recruitment manouvres aid the open lung approach by increasing alvolear recruitment. In practice, following a recruitment manouvere:
...
* Death\
Improving with better preventative care and decreased VILI. Mortality varies on:
    * Severity:
        * ~35% mild
        * ~40% moderate
        * ~45% severe
    * Cause and cormorbidities:
        * Decreased In trauma
        * Increased In elderly, chronic or acute organ failures, and sepsis
* Chronic lung disease\
Pulmonary function tests normalise in 6-12 months.
* Persistent critical illness\
Increased In survivors of ARDS compared to non-ARDS ICU patients.
