# Serotonin Syndrome {#sec-serotonin}
...
+-------------------------------------+----------------------------+--------------+
| Monoamine Oxidase Inhibitors        | Serotonin Releasing Agents | Other        |
+=====================================+============================+==============+
| **Irreversible inhibitors:**        | **SSRIs**:                 | * Lithium    |
|                                     |                            | * Buspirone  |
| * Phenelzine                        | * Fentanyl                 | * Tryptophan |
| * Tranylcypromine                   | * Tramadol                 |              |
| * Iproniazid                        | * Pethidine                |              |
| * Isocarboxazid                     | * Dextromethorphan         |              |
+-------------------------------------+----------------------------+              |
| **Reversible inhibitors** of MAO-A: | **Sympathomimetics**:      |              |
|                                     |                            |              |
| * Moclobemide                       | * Ecstasy                  |              |
|                                     | * Amphetamines             |              |
|                                     | * Bath salts               |              |
+-------------------------------------+----------------------------+              |
| **Non-psychotropics**:              | **Herbal**:                |              |
|                                     |                            |              |
| * Linezolid                         | * St John's Wort           |              |
| * Methylene blue                    |                            |              |
+-------------------------------------+----------------------------+--------------+

:::column-margin
Drugs without significant risk of toxicity include serotonin antagonists and drugs that do not agonise 5-HT~2~, including:
...
:::column-margin
Neuroleptic Malignant Syndrome is a always a differential for serotonin syndrome.\
\
