...
+==================================+====================================+====================+
| **Monoamine Oxidase Inhibitors** | **Irreversible inhibitors**        | * Phenelzine       |
|                                  |                                    | * Tranylcypromine  |
|                                  |                                    | * Iproniazid       |
|                                  |                                    | * Isocarboxazid    |
|                                  +------------------------------------+--------------------+
...
|                                  +------------------------------------+--------------------+
|                                  | **Non-psychotropics**              | * Linezolid        |
|                                  |                                    | * Methylene blue   |
+----------------------------------+------------------------------------+--------------------+
| **Serotonin Releasing Agents**   | **SSRIs**                          | * Fentanyl         |
|                                  |                                    | * Tramadol         |
|                                  |                                    | * Pethidine        |
|                                  |                                    | * Dextromethorphan |
|                                  +------------------------------------+--------------------+
|                                  | **Sympathomimetics**               | * Ecstasy          |
|                                  |                                    | * Amphetamines     |
|                                  |                                    | * Bath salts       |
|                                  +------------------------------------+--------------------+
