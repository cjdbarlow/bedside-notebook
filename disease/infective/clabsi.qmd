...
+===========================+==========================================================+===============================================================+
| **Gram Positive Cocci**   | * Coagulase-positive staphylococci                       | * Coagulase-negative staphylococci                            |
|                           |     * *S. aureus*                                        |     * *S. epidermidis*                                        |
|                           | * *Strep. pneumoniae*                                    |     * *S. haemolyticus*                                       |
|                           | * *Strep. pyogenes*                                      |     * *S. hominis*                                            |
|                           | * *Strep. agalactiae*                                    |     * *S. saprophyticus*                                      |
|                           |                                                          |     * *S. lugdunensis*                                        |
...
|                           |                                                          | * *Micrococcus* spp.                                          |
+---------------------------+----------------------------------------------------------+---------------------------------------------------------------+
| **Gram Positive Bacilli** | * *Listeria monocytogenes*                               | * *Corynebacterium* spp.                                      |
|                           |                                                          | * *Bacillus* spp.\                                            |
...
+---------------------------+----------------------------------------------------------+---------------------------------------------------------------+
| **Fungi**                 | * *Crytptococcus neoformans*                             |                                                               |
|                           | * *C. albicans*                                          |                                                               |
+---------------------------+----------------------------------------------------------+---------------------------------------------------------------+
