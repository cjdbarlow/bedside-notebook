...
:::column-margin
Amylase has been replace by lipase and has no further role in diagnosis of pancreatitis.
::

* Blood
	* Lipase\
	90% sensitive and specific for acute disease.
		* Elevations from non-pancreatic causes are typically <3x ULN
	* LFTs\
...
* Pharmacological
	...
	* Insulin/dextrose\
	If hypertriglyceridaemia.
		...
		* Effect achieve when enough insulin is provided such that the BSL does not rise in the face of dextrose infusion
* Procedural
	* Open necrosectomy\
...
* [WATERFALL](https://www.nejm.org/doi/full/10.1056/NEJMoa2202884)
