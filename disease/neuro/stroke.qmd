...
* **Focal** (usually)
* **Negative**\
i.e. Loss of usual function, rather than the addition of a new sensation.
* **Maximal** at **onset**
...
:::column-margin
Stroke is related to a TIA, which is a clinical syndrome with:
...
Stroke death in Australia in >55, stratified by sex.
:::
...
* Interruption to blood flow leading to cellular failure\
Disruption to receptor and channel function, free radial release, mitochondrial dysfunction, membrane disruption, and cell death.
* An ischaemic stroke has a:
	* **Core infarct**\
	Irretrievably damaged centre of brain, seen as cyotoxic oedema on CT. A large (>50mL) core suggests less recoverable tissue by endovascular therapy.
	* **Ischaemic penumbra**\
...
:::caution
Stroke severity is semi-objectively described using the [NIHSS](https://www.mdcalc.com/calc/715/nih-stroke-scale-score-nihs). However, **endovascularly correctable** stroke may have a **low NIHSS** score. NIHSS is **not** a guide for identifying patients eligible for reperfusion therapies.
:::
...
* Mortality and morbidity are higher with specialist stroke unit admission\
	...
	* **Hypertension**\
	Aims (SBP/DBP):
		...
		* No thrombolysis: <220/<120 or end-organ damage\
		Reduce cautiously (aim <15% reduction/24 hours) if not urgently required - ↑ morbidity with rapid ↓.
		* Agents
...
* D
	...
	* **Seizure** (<10%)\
	Uncommon. Risk increase with stroke severity, and may indicated haemorrhagic transformation.
	* Hyperglycaemia (40%)
		* Common
...
~50% in-hospital mortality (lowest for ischaemic stroke) and significantly increased disability in survivors.
