...
1. **Neural pathways run vertically** through the entire length of the brainstem, running **either medially or laterally**
...
Therefore, brainstem vascular syndromes can be geographically localised to the medial or lateral aspect of a specific structure by identifying both the affected pathway and cranial nerves.

The relevant principles are summarised as the **Brainstem Rule of Four**, which states that there are:

1. **Four** cranial nerves:
	* Above the pons\
	CN III-IV. As CN I and II arise above the midbrain, they will unaffected by a brainstem lesion.
	* In the pons\
	CN V-VIII.
	* In the medulla\
	CN IX-XII.\
