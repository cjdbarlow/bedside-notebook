...
:::column-margin
Management of active seizures is covered under @sec-seizure.
:::
...
| Mechanism                                 | Drug              |
+===========================================+===================+
| ↑ GABA Cl^-^ channel opening frequency    | * Benzodiazepines |
|                                           | * Tiagabine       |
|                                           | * Gabapentin      |
+-------------------------------------------+-------------------+
...
+-------------------------------------------+-------------------+
| ↓ Inward voltage-gated positive currents  | * Phenytoin       |
|                                           | * Carbamazepine   |
|                                           | * Ethosuximide    |
+-------------------------------------------+-------------------+
| ↑ Outward voltage-gated positive currents | * Valproate       |
+-------------------------------------------+-------------------+
| Pleotropic                                | * Valproate       |
|                                           | * Lamotrigine     |
|                                           | * Topiramate      |
+-------------------------------------------+-------------------+
:::
