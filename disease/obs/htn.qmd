...
* Common
* Associated with ↑ maternal, foetal, and neonatal morbidity and mortality
...
* Classified into four sub-groups:
	...
	* **Chronic hypertension with super-imposed preeclampsia/eclampsia**
...
* Severity
	...
	* Generally a high-cardiac output state, associated with inappropriately high SVR
...
* Admission\
May be required for BP management.
* Delivery\
