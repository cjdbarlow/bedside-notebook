...
Hypocalcaemia is a common and occasionally severe electrolyte disorder. In plasma, calcium may be:

* Ionised calcium (1.1-1.3mmol/L)\
	* ~50% of serum calcium in normal persons
	* Only biologically important version as bound calcium is not active 
* Total (serum) calcium (2.2-2.5mmol/L)\
Reflects sum of bound and ionised calcium.
	* Majority of non-ionised calcium is bound to albumin, and so is affected by albumin levels\
...
Calcium is an important and highly regulated cation with multiple critical functions:
...
* PTH\
	* Release stimulated by ↓ serum calcium
...
:::column-margin
Primary alkalosis causes an ionised hypocalcaemia by ↑ calcium binding to albumin. However, many other causes of hypocalcaemia also cause metabolic *acid*osis (e.g. renal failure, TLS).
:::
