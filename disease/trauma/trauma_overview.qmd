...
+====================+=============================+================================+
| Car                | * Windshield damage         | * Head                         |
|                    |                             |     * Scalp                    |
|                    |                             | * Cervical spine               |
|                    +-----------------------------+--------------------------------+
|                    | * Steering wheel damaged    | * Chest                        |
|                    | * No steering wheel airbag  | * Cardiac                      |
|                    +-----------------------------+--------------------------------+
|                    | * Dashboard damage          | * Head                         |
|                    |                             | * Cervical spine               |
|                    |                             | * Pelvis                       |
|                    |                             | * Lower limb                   |
|                    +-----------------------------+--------------------------------+
|                    | * Sudden deceleration       | * Aortic dissection            |
|                    |     * Head-on               | * Mesenteric tear              |
...
|                    |                             | * Cervical spine               |
+--------------------+-----------------------------+--------------------------------+
| Motorcycle         | * Helmet                    | * Cervical spine\              |
|                    |                             | Head relatively protected.     |
+--------------------+-----------------------------+--------------------------------+
| Pedestrian vs. car | * Adult                     | * Lower limb\                  |
|                    |                             | Bumper impact.                 |
|                    |                             | * Head\                        |
|                    |                             | Windshield impact.             |
|                    +-----------------------------+--------------------------------+
...
|                    |                             | Bumper impact.                 |
+--------------------+-----------------------------+--------------------------------+
| Falls              | * Land on feet              | * Lower extremity              |
|                    |                             |     * Bilateral calcaneal      |
|                    |                             | * Pelvic fracture              |
