...
:::column-margin
My approach: Using a 3mL syringe, draw up 0.3mL (15μg) of fentanyl, 0.2mL of intrathecal morphine (100μg), and then 2.5mL of heavy, to a total volume of 3mL. This will lead to a small ↑ in fentanyl than stated (due to the needle dead space); which is fine, and the method is quick.
::: 

* Perform spinal\
[Many different options for dosing](#dosing). A reliable recipe (with a total volume of 3ml) is:
	* 2.2-2.5ml of 0.5% heavy bupivacaine
	* 15μg of fentanyl
...
20-30ml/hr of 100μg/ml solution.
* Test the block
	* No block\
