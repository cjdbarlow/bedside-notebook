...
Therefore requires a rebreathing system and a CO~2~ absorber.
...
If oxygen consumption exceeds oxygen delivery:
	...
	* Circuit mixture will become relatively hypoxic  
	Oxygen is consumed, however nitrogen and inhalational agent amounts remain constant; this results in a decreased FiO~2~.
* Increased soda-lime concentration  
As less CO~2~ will be scavenged, soda-lime consumption will increase.
...
As volatile agents will be ceased, there is no benefit to low-flow techniques. Additionally, high FGF is required to ensure adequate washout of CO~2~. 
...
* Estimate VO~2~
	* VO~2~ can be crudely measured using the Brody Formula: $$ VO_2 = 3.5 \times kg$$  
...
* Standard Induction
* Initial Phase
	* FGF of 4L/min with 40% FiO~2~  
	3L/min air, 1L/min O~2~; will lead to an FiO~2~ of 35-40%.
	* Vaporiser:
		* Sevoflurane 3.5%
		* Isoflurane 2.5%
		* Desflurane 6%
* At target MAC (0.8-1)
	* Decrease FGF to 0.5L/min with 68% FiO~2~  
	0.3L/min air, 0.2L/min O~2~.
	* Increase vaporiser:
		* Sevoflurane 5%
		* Isoflurane 5%
		* Desflurane 8%
...
* Reversal
	...
	* At the last suture, purge system with 100% O~2~ at 6L/min  
...
* Standard induction
* Initial Phase
	* FGF of 4.4L/min with 32% FiO~2~  
	1.4L/min O~2~ and 3L/min N~2~O; will lead to an FiO~2~ of 30-40%.
	* Vaporiser:
		* Sevoflurane 2-2.5%
		* Isoflurane 1-1.5%
		* Desflurane 4-6%
* At target MAC (0.8-1)
	* Reduce FGF to 0.5L/min (0.3L/min O~2~ and 0.2L/min N~2~O)
	* Increase vaporiser:
		* Sevoflurane 3-3.5%
		* Isoflurane 2.5%
		* Desflurane 5-7.5%
...
* Reversal
	...
	* Continue FGF at 0.5L/min
	* Begin spontaneous ventilation
	* At the last suture, purge the system with 100% O~2~ at 6L/min
