# Transfusion Reactions {#sec-transfusion_reactions}

Adverse reactions to allogenic blood can be classified by:

:::column-margin
Reactions specific to infusion of vast volumes of blood product are covered under @sec-critical_bleeding.
:::
...
TRALI is defined as **acute respiratory distress** that:

* Occurs within **6 hours** of transfusion
* Results in hypoxaemia
* Does not have another course
...
* Characterised by:
	...
	* Dyspnoea
	* Hypoxaemia
* Due to **interstitial oedema**, generally **lasting <48 hours**
* The **major** cause of **transfusion-related mortality**
* Due to **leukoagglutininins** in donor plasma promoting neutrophil activation
	* **Neutrophils** are **sequestered** in **lung microcirculation**
		* Subsequent endothelial injury and activation ↑ degree of sequestration\
		More common in:
			* Critically ill
			* Smokers
			* Shock states
			* High ventilator pressures
	* Leukoagglutinins are also more common in multiparous women
