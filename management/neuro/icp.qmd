...
* Involves **three tiers** of management\
	...
	* **Third Tier**:
		...
		* Aggressive **hyperventilation**
			...
			* It *may* have a role for short term control of ↑ ICP prior to some definitive therapy\
			e.g. the patient who blows a pupil during transfer to the OR.
		* Decompressive **craniectomy**
			* *Early* decompressive craniectomy has no role
			* *Late* decompressive craniectomy has questionable role:
				* Performed for refractory ↑ ICP
				* ↓ Mortality
				* ↑↑ Morbidity in survivors

:::column-margin
Each tier is characterised by ↑ invasiveness.
:::
