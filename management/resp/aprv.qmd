...
Patient can breath throughout the respiratory cycle, across two pressure levels.
...
* P-High\
	...
	* ↓ May lead to hypoxaemia, derecruitment, and ↑ PaCO~2~.\
	The P-high determines the mandatory tidal volume, as this is the driving pressure.
* P-Low\
Note this is *not* the PEEP, as expiration is (or should be) terminated before flow ceases. 
...
* T-high\
Time spent at P-high. Initially at ~9x the T-low, which should provide 10-14 release breaths/minute.
