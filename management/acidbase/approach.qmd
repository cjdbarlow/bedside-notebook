...
This section outlines the chemical principles underlying a reasonably standard approach to blood gas interpretation.
...
* Determine PAO~2~ using the AGE
* $PAO_2 = FiO_2 \times 713 - PaCO_2 \times 1.25$
...
:::column-margin
If both pH and PaCO~2~ are normal then a dual metabolic problem is possible, but unlikely.
:::

2. **Determine compensation**
	* Metabolic: PaCO~2~ in mmHg should ≃ the last 2 digits of pH (after the decimal point)
	* Respiratory:
		* Compensated if SBE is normal
		* Uncompensated if $SBE = 0.4 \times (PaCO_2 - 40)$
